...
np.savetxt('/home/ubuntu/Desktop/FMQR/Python/prd_q1.txt', binary_codes_1,  fmt='%d',  delimiter=',')
np.savetxt('/home/ubuntu/Desktop/FMQR/Python/prd_q2.txt', binary_codes_2,  fmt='%d',  delimiter=',')
np.savetxt('/home/ubuntu/Desktop/FMQR/Python/prd_q3.txt', binary_codes_3,  fmt='%d',  delimiter=',')
